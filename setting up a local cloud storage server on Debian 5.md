...
2. Install it ("graphical install" is usually a reasonbale option)
    ...
    - When it comes to mirrors, choose United States as the country, then choose "deb.debian.org"
...
5. Set a static local IPv4 address
    ...
    **Now, edit the file to this:**
    ...
    `iface enp0s3 inet static`
            ...
            gateway 192.168.1.1
            dns-domain debiand2 #Replace "debiand2" with your hostname
            dns-nameservers 192.168.1.1 1.1.1.1 1.0.0.1 #The numbers are: <gateway> <preferred dns server 1> <preferred dns server 2>
...
6. Testing the network
    ...
    You'll find it right before the broadcast address `x.x.x.255`
